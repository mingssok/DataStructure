...
public class Run {
	...
	public void run() {
		...
		int number;
		String str = "";
		LinkedlistBag bag = new LinkedlistBag();
		...
		while (T) {
			...
			case 3: // 1번 물품 조회
				try {
					...
					System.out.println("오류 : 아직 가방에 물품이 없습니다.");
					break;
				}
			...
			case 4: // 다음 물품 조회
				String tmp = "";
				try {
					Object temp = bag.getNext();
					tmp = (String) temp;
				} catch (Exception e) {
					System.out.println("오류 : 다음 물품이 없습니다.");
					break;
				}
				System.out.print("다음물품은 " + tmp + "입니다.");
				break;
